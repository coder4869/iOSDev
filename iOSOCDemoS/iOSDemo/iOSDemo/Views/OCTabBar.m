 ...
 *                      http://www.cocoachina.com/ios/20160627/16829.html
 *
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        MethodExchange(@selector(layoutSubviews), @selector(s_layoutSubviews), aclass);
        MethodExchange(@selector(hitTest:withEvent:), @selector(s_hitTest:withEvent:), aclass);
        MethodExchange(@selector(touchesBegan:withEvent:), @selector(s_touchesBegan:withEvent:), aclass);
    });
}
